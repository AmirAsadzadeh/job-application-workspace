...
import { localDateString } from "../../../../shared/positionSchema";
import {
  ...
  return (
    <fieldset className="publication-editor">
      ...
      <div className="publication-links">
        {links.map((link, index) => (
          <div className="publication-link-row" key={index}>
            ...
            <label>Job posting URL<input aria-label={`Job posting URL ${index + 1}`} inputMode="url" value={link.url} onChange={(event) => updateUrl(index, event.target.value)} /></label>
      ...
      <div className="career-page-grid">
        <label className="career-page-field">Organization career-page URL<input aria-label="Organization career-page URL" inputMode="url" value={careerPageUrl ?? ""} onChange={(event) => updateCareerUrl(event.target.value)} /></label>
