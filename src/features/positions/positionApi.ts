import { ListViewPreferenceSchema, PositionSchema, PositionSummarySchema, ReferenceDataSchema, type CreatePositionInput, type ListViewPreference, type PositionDetailsUpdate, type PositionQuestionInput, type PositionStatus, type ReadingItemInput, type ReorderPositionInput } from "../../../shared/positionSchema";
import { WorkspacePreviewSchema, WorkspaceRestoreResultSchema } from "../../../shared/workspacePackageSchema";
