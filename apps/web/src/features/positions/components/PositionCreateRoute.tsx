...
import { CreatePositionInputSchema, EMPTY_RICH_TEXT_DOCUMENT, type CompanyLogoInput as CompanyLogoValue, type EmploymentType, type JobPlatformLink, type RichTextDocument } from "@workspace/domain/positionSchema";
...
type FormState = {
  ...
  careerPageApplicationStatus: import("@workspace/domain/positionSchema").ApplicationChannelStatus | null;
