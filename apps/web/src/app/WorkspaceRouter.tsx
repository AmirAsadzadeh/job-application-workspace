...
type WorkspaceApi = NonNullable<ComponentProps<typeof PositionList>["api"]> & NonNullable<ComponentProps<typeof PositionCreateRoute>["api"]> & NonNullable<ComponentProps<typeof PositionDetailsRoute>["api"]>;
...
export function WorkspaceRouter({ api, headerActions }: { api?: WorkspaceApi; headerActions?: ReactNode }) {
  ...
  return <main className="app-shell">
    {route.kind === "list" && <header className="workspace-header"><span>Positions</span><span className="workspace-header-actions"><span className="workspace-label">Hiring workspace</span>{headerActions}</span></header>}
